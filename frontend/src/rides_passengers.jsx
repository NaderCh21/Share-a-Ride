...
import { MapPin, Calendar, Car, User, Users, Star, X} from "lucide-react"; // Icons
    ...
    return (
        <section id="available-rides" className="available-rides">
            ...
            <div className="ride-filters">
              ...
              <select name="time" value={filters.time} onChange={handleFilterChange}> // Changed input time to select
